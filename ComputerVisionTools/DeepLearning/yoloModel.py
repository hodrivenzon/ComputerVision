...
if __name__ == '__main__':
    ...
    # WIDTH, HEIGHT = (705, 341)

    ####    Detect Cars on a single photo ####

    output_image = Car_detection_single_photo(input_photo='photos/high-st-image.jpg')
    ...
    Car_detection_video(input_video_name='photos/Daytona Beach 4K  Scenic Drive_360p.mp4', output_video_name='photos/delete.avi',
                        frames_to_save=200)